...
/*
 ...
 {  LPC_GPIO0,  SSEL0,  FUNC2  },      //SPI_SSEL_0
 ...
 {  LPC_GPIO1,  P1_18,  FUNC0  },      //USB_UP-LED
 {  LPC_GPIO1,  USB_UP_LED,  FUNC1  },      //USB_UP-LED
 {  LPC_GPIO1,  PWM1_1,  FUNC2  },      //USB_UP-LED
 {  LPC_GPIO1,  CAP1_0,  FUNC3  },      //USB_UP-LED
 ...
 {  LPC_GPIO1,  MC2A1_0,  FUNC2  },      //P1_28
 {  LPC_GPIO1,  MAT0_0,  FUNC3  },      //P1_28
 ...
 {  LPC_GPIO2,  P2_2,  FUNC0  },      //PWM 1_3
 {  LPC_GPIO2,  PWM1_3,  FUNC1  },      //PWM 1_3
 {  LPC_GPIO2,  CTS1,  FUNC2  },      //PWM 1_3
 {  LPC_GPIO2,  TRACEDATA3,  FUNC3  },      //PWM 1_3
 {  LPC_GPIO2,  P2_3,  FUNC0  },      //PWM 1_4
 {  LPC_GPIO2,  PWM1_4,  FUNC1  },      //PWM 1_4
 {  LPC_GPIO2,  DCD1,  FUNC2  },      //PWM 1_4
 {  LPC_GPIO2,  TRACEDATA2,  FUNC3  },      //PWM 1_4
 {  LPC_GPIO2,  P2_4,  FUNC0  },      //PWM 1_5
 {  LPC_GPIO2,  PWM1_5,  FUNC1  },      //PWM 1_5
 {  LPC_GPIO2,  DSR1,  FUNC2  },      //PWM 1_5
 {  LPC_GPIO2,  TRACEDATA1,  FUNC3  },      //PWM 1_5
 {  LPC_GPIO2,  P2_5,  FUNC0  },      //PWM 1_6
 {  LPC_GPIO2,  PWM1_6,  FUNC1  },      //PWM 1_6
 {  LPC_GPIO2,  DTR1,  FUNC2  },      //PWM 1_6
 {  LPC_GPIO2,  TRACEDATA0,  FUNC3  },      //PWM 1_6
...
const Pinconfig_t GPIOPins[]={
		 /* Setting functionality for Leds as GPIO */
		 {  .GPIOx=LPC_GPIO1,  .pin=P1_19,  .func=FUNC0  },      //P1_19
		 {  .GPIOx=LPC_GPIO1,  .pin=P1_20,  .func=FUNC0  },      //P1_20
		 {  .GPIOx=LPC_GPIO1,  .pin=P1_29,  .func=FUNC0  },      //TEST_LED

		 /* Setting functionality for Button as GPIO */
		 {  .GPIOx=LPC_GPIO2,  .pin=P2_10,  .func=FUNC0  }      //P2_10/BLD.

};

const Pinconfig_t ClkOutPin[]={
		 /* Selecting Clock out functionality for the pin */
		 {  .GPIOx=LPC_GPIO1,  .pin=CLKOUT,  .func=FUNC1  }      //P1_27
};
...
{
	/* Setting the GPIO functionality for the selected pins*/
	vPinmuxSel(GPIOPins[0].GPIOx,GPIOPins[0].pin,GPIOPins[0].func);
	vPinmuxSel(GPIOPins[1].GPIOx,GPIOPins[1].pin,GPIOPins[1].func);
	vPinmuxSel(GPIOPins[2].GPIOx,GPIOPins[2].pin,GPIOPins[2].func);
	vPinmuxSel(GPIOPins[3].GPIOx,GPIOPins[3].pin,GPIOPins[3].func);

	/* Selecting Clock out functionality for the pin */
	vPinmuxSel(ClkOutPin[0].GPIOx,ClkOutPin[0].pin,ClkOutPin[0].func);
...
void vPinmuxSel(LPC_GPIO_TypeDef* uiGPIOx, uint8_t ucPinnum, uint8_t ucfunctionality)
{
 /* Converting the base address into a integer value */
 uint32_t portbaseaddress = (uint32_t) uiGPIOx;
 /* portbaseaddress can be 0x2009C000,0x2009C020,0x2009C040,0x2009C060,0x2009C080 */

 /* Extracting the port number from the port base address */
  uint32_t portnum = (portbaseaddress>>5) & 0x0F;
 /*0x2009C000 >> 5  0010 0000 0000 1001 1100 0000 0000 0000 >>5 & 0x0F <=>  0000 0000 0000 0000 0000 0000 0000 0000
  *0x2009C020 >> 5  0010 0000 0000 1001 1100 0000 0010 0000 >>5 & 0x0F <=>  0000 0000 0000 0000 0000 0000 0000 0001
  *0x2009C040 >> 5  0010 0000 0000 1001 1100 0000 0100 0000 >>5 & 0x0F <=>  0000 0000 0000 0000 0000 0000 0000 0010
  *0x2009C060 >> 5  0010 0000 0000 1001 1100 0000 0110 0000 >>5 & 0x0F <=>  0000 0000 0000 0000 0000 0000 0000 0011
  *0x2009C080 >> 5  0010 0000 0000 1001 1100 0000 1000 0000 >>5 & 0x0F <=>  0000 0000 0000 0000 0000 0000 0000 0100
  */
   ...
   *((uint32_t *)((&LPC_PINCON->PINSEL0) + pinselnum)) |= ucfunctionality<<bitpos;
